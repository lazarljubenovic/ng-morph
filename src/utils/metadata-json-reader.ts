...
interface MetadataSymbol_Reference_External extends MetadataSymbolBase<Symbolic.Reference> {
  module: string
  name: string
  line: number
  character: number
...
interface MetadataSymbol_Reference_Internal extends MetadataSymbolBase<Symbolic.Reference> {
  nam: string
}

type MetadataSymbol_Reference = MetadataSymbol_Reference_External | MetadataSymbol_Reference_Internal

interface MetadataSymbol_Constructor extends MetadataSymbolBase<Symbolic.Constructor> {
  parameterDecorators: Array<Array<MetadataSymbol_Call>>
  parameters: Array<MetadataSymbol_Reference>
}

interface MetadataSymbol_Function extends MetadataSymbolBase<Symbolic.Function> {
  parameters: string[]
  value: {
...
function isMetadataSymbol<TSymbolic extends Symbolic> (symbol: TSymbolic) {
  return (metadata: MetadataSymbol): metadata is MetadataSymbolMap[TSymbolic] => metadata.__symbolic == symbol
}
...
function isMetadataProvider<TKey extends MetadataProviderKey> (metadataProviderKey: TKey) {
  return (metadataProvider: MetadataProvider): metadataProvider is MetadataProviderMap[TKey] => {
